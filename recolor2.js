...
async function recolor(imagePath, targetPath) {
  try {
    ...
    image.scan(0, 0, image.bitmap.width, image.bitmap.height, function(x, y, idx) {
      ...
      // Target purples (Bride's dress)
      if (h > 0.60 && h < 0.90 && s > 0.05) {
        // Shift hue to pink, preserve lightness for details!
...
async function main() {
  await recolor('./public/final.jpg', './public/final_pink_white.jpg');
  await recolor('./public/Finaltwo.png', './public/Finaltwo_pink_white.png');
}
