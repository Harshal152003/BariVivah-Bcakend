      ...
      <div className="h-screen overflow-hidden bg-white flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
                        ...
                        <button
                          ...
                          className={`w-full flex items-center space-x-3 p-3 rounded-lg transition-all duration-200 ${
                            activeTab === section.id 
                              ? 'bg-[#FB2467] text-white shadow-lg' 
                              : 'hover:bg-[#FB2467]/10 text-gray-700 hover:text-[#FB2467]'
                          }`}
                        >
          ...
          <div className="hidden lg:flex flex-col w-64 bg-white shadow-xl border-r border-gray-200 h-full">
            ...
            <div className="p-4 pb-8 border-t border-gray-200 mt-auto">
              <div className="bg-green-50 rounded-lg p-3">
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                  <span className="text-sm font-medium text-green-800">System Online</span>
          ...
          <div className="flex-1 overflow-y-auto h-full">
            {/* Top Header */}
            <div className="bg-[#FB2467] shadow-lg rounded-lg mx-2 lg:mx-6 mt-2 lg:mt-4 p-4 lg:p-6">
